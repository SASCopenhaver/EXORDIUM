...
<!---
<cfdump var="#local.sprSerializeJSON_P_UI_ELEMENT_DRIVER_s#" abort="true" >
<cfset local.sprSerializeJSON_P_UI_ELEMENT_DRIVER_s = '{"COLUMNS":["ROWID","ELEMENT_ID","MENU_ID","PAGE_ID","ELEMENT_NAME","ELEMENT_LABEL","ELEMENT_TYPE","ELEMENT_CLASS","ORD_NR","ELEMENT_MANDATORY","ELEMENT_SIZE","ELEMENT_MAX_SIZE","ELEMENT_TOOLTIP"],"DATA":[["AAAYZHAAOAAAADkAAA",21,3,21,"hdnROWID",null,"hidden",null,10,"Y",null,null,null],["AAAYZHAAOAAAADkAAB",22,3,21,"hdnMENU_ID",null,"hidden",null,20,"Y",null,null,null],["AAAYZHAAOAAAADkAAC",23,3,21,"txtMENU_TX","MENU ITEM","text",null,30,"Y",null,null,null],["AAAYZHAAOAAAADkAAD",24,3,21,"txtMENU_PAGE_NAME","PAGE","text",null,40,"Y",null,null,null],["AAAYZHAAOAAAADkAAE",25,3,21,"spnORD_NR","ORDER NUMBER","spinner",null,50,"Y",null,null,null],["AAAYZHAAOAAAADkAAF",26,3,21,"selACTIVE_YN","ACTIVE","select",null,60,"Y",null,null,null],["AAAYZHAAOAAAADkAAG",27,3,21,"cbnRESET","Reset","button","ui-button ui-widget ui-corner-all",70,"Y",null,null,null],["AAAYZHAAOAAAADkAAH",28,3,21,"cbnNEW","New","button","ui-button ui-widget ui-corner-all",80,"Y",null,null,null],["AAAYZHAAOAAAADkAAI",29,3,21,"cbnSAVE","Save","button","ui-button ui-widget ui-corner-all",90,"Y",null,null,null]]}'>
--->
...
function f_onClickCBN_PageSample(argCBName)
{
	switch(argCBName)
	{
		...
		case "cbnNEW":
			...
			of_ShowHideMsg("show",
							"highlight",
							"Please fill out all mandatory fields for the new record.", 
							4000);
		break;
		//
		case "cbnSAVE":
